...
ARRAY+=('Sophos Antivirus':'installSophos':'SophosEnterprise')
ARRAY+=('LightSpeed User Agent':'lightspeed':'LightSpeedUserAgent')
...
ARRAY+=('User Environment':'userEnvironment':'UserEnvironment')

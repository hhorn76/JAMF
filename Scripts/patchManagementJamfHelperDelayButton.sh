...
# This script can be used for patch management to update Mozilla Firefox with the use of the Jamf Helper Application with a delay button.

#Variables for customization
APPLICATION="Firefox"
CLOSEAPPLICATION="Firefox"
